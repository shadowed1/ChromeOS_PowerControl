#!/bin/bash
yay -S --noconfirm python-cairo
sudo -E curl -fsSL https://raw.githubusercontent.com/shadowed1/ChromeOS_PowerControl/main/gui.py -o /bin/powercontrol-gui 2>/dev/null
