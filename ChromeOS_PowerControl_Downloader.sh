...
echo "${RESET}"
echo ""
echo "${YELLOW}Instead of using VT-2 to manually type commands, I recommend installing ${BLUE}sudoCrosh${RESET} (copy paste and run in crosh shell):"
echo "bash <(curl -s "https://raw.githubusercontent.com/shadowed1/sudoCrosh/main/sudocrosh_downloader.sh?$(date +%s)")${RESET}"
echo ""
