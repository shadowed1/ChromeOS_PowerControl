...
curl -L https://raw.githubusercontent.com/shadowed1/ChromeOS_PowerControl/refs/heads/main/ChromeOS_PowerControl_Installer.sh -o /home/chronos/user/tmp/ChromeOS_PowerControl_Installer.sh
