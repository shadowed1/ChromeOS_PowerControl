...
- 0.42: `Replaced cat logic with read for lower cpu usage on monitoring loops. Thanks to Denny and Saragon for great ideas. Removed sleep_watcher script; not needed.` <br><br> 
