...
0.35: `Added lid sleep logic for independent sleep rules when closing lid on battery and power. Added support for mem_sleep to be changed to s2idle for improved ectool control.
Fixed bug with SleepControl altering display brightness incorrectly. Fixed minor syntax issues.`
