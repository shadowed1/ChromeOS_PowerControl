...
- 0.34: `Added sleepcontrol mode command to alter suspend_mode easily and preserve on boot. Enabling freeze preserves batterycontrol logic during sleep.
Fixed config loading logic in sleepcontrol so settings update properly.` <br><br>
