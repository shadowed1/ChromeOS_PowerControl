...
- 0.50: `Relaxed FanControl default settings. Fixed lid sleep bug. Fixed bug with redownloading scripts. Improved FanControl and BatteryControl loop resets. Fixed typo with GPUControl startup. Added 'mon' shortcut for monitor commands` <br><br>
