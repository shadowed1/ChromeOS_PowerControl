...
- 0.53: `Streamlined GUI app and fixed numerous bugs with it. Added usage command for BatteryControl. Added monitor command for GPUControl. GPUControl now runs in a loop for dynamic config adjustments.` <br><br>
