...
- 0.25: `Simplified file structure thanks to DennyL's crouton upstart script from 2014. 
to do: Clean up UI. Rework FanControl zero RPM ramp to be gradual. Improve step-up and step-down algorithm.`
