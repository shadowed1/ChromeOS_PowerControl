...
- 0.70 (in progress): `Changed "min" to "minutes" on GUI app for SleepControl to be more clear. Cleaned up FanControl's gettemp loop. Added battery preservation feature. If Chromebook is asleep for awhile and reaches 3% battery and not charging, it will power off vs drain entirely.` <br><br>
