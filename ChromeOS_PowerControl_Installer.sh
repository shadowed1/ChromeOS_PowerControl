...
echo "sudo sleepcontrol battery 5 10        # Display off in 10m and ChromeOS sleeps in 15m when on battery"
echo "sudo sleepcontrol power 15 30         # Display off in 15m and ChromeOS sleeps in 30m when on power" 
