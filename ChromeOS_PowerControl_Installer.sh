...
echo "sudo powercontrol stop                # Default CPU temperature curve. no_turbo restored."
echo "sudo powercontrol no_turbo 1          # 0 is default Intel Turbo Boost On behavior."
echo "sudo powercontrol max_perf_pct 75     # 0 to 100%. 100 is default behavior; can be run standalone."
echo "sudo powercontrol min_perf_pct 50     # Minimum clockspeed CPU can reach at max_temp."
echo "sudo powercontrol max_temp            # Controls the peak  clockspeed part of the curve."
echo "sudo powercontrol min_temp            # Controls the the temp when CPU runs at 100% clockspeed part of the curve."
