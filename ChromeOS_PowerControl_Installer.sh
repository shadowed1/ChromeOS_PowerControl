...
read -rp "${BOLD}Enable Global Commands for ${RESET}${BOLD}${CYAN}PowerControl${RESET}${BOLD}, ${GREEN}${BOLD}BatteryControl${RESET}${BOLD}, ${YELLOW}${BOLD}FanControl${RESET}${BOLD}, ${MAGENTA}GPUControl${RESET}${BOLD}, ${RESET}${BLUE}SleepControl${RESET}${BOLD}? (y/n):$RESET " link_cmd
if [[ "$link_cmd" =~ ^[Yy]$ ]]; then
