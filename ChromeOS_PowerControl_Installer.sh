...
echo "sudo powercontrol startup             # Initiate no_turbo and powercontrol startup on-boot installer"
...
echo "sudo batterycontrol startup           # Initiate batterycontrol startup on-boot installer"
