...
declare -a files=(
  ...
  "no_turbo.conf" "batterycontrol.conf" "powercontrol.conf" ".last_simulated_times"
...
echo "sudo sleepcontrol battery 5 10        # Turns off display in 10m and ChromeOS sleeps in 15m when on battery"
echo "sudo sleepcontrol power 15 30         # Turns off display in 15m and ChromeOS sleeps in 30m when on power" 
