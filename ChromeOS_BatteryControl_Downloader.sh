...
echo "ChromeOS_BatteryControl requires running installer.sh downloaded in /home/chronos/user/tmp/ChromeOS_BatteryControl as root user in VT-2 console to finish installing!"
